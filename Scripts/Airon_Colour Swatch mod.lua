...
preset_default = { generate_colour = 1 , -- 1-> generated colours, 0->colour list included in preset
                   saturation_max = 0.7 , --0.520
                   saturation_min = 0.7 , --1.000
                   luminance_max = 0.85 , -- 0.98
                   luminance_min = 0.58 , -- 0.11
                   sw_max_x = 23 ,   -- 160 - # of swatches horizontally
                   sw_max_y = 3  ,   -- 60 - # of swatches vertically
                   sw_w = 16     ,     -- 4 - swatch width
                   sw_h = 12    ,      -- 4 - swatch height
                   sw_border = 2,     -- 0 - area around the swatches in pixels
