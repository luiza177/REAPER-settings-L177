sTitle = 'Theme adjuster custom (12 palettes + Items)'
reaper.ClearConsole()
...
palette = {}
palette.idx = {'Rv6','Pride','Warm','Cool','Vice','OK','Soft','Forest','Fire','Hard','Autumn','Synthwave'}
...
palette.OK = {{6,167,125},{51,101,138},{80,140,164},{189,30,30},{71,104,44},{242,149,89},{191,78,48},{150,112,91},{168,70,160},{188,171,121}}
--
palette.Forest = {{54, 72, 56},{84, 104, 74},{93, 126, 75},{111, 153, 96},{155, 179, 130},{95, 151, 124},{80, 138, 119},{63, 118, 113},{54, 94, 100},{43, 73, 82}}
palette.Autumn = {{107, 76, 74},{140, 107, 86},{184, 154, 116},{215, 187, 143},{214, 161, 107},{191, 121, 64},{168, 94, 56},{129, 69, 45},{119, 95, 113},{112, 73, 82}}
palette.Soft = {{204, 94, 94},{207, 131, 102},{222, 171, 122},{212, 209, 125},{152, 214, 102},{92, 209, 108},{99, 188, 207},{109, 154, 218},{116, 121, 209},{121, 100, 184}}
palette.Hard = {{240, 71, 43},{228, 154, 38},{241, 196, 15},{111, 184, 66},{68, 156, 199},{74, 119, 193},{129, 71, 212},{201, 83, 161},{176, 177, 161},{108, 120, 116}}
palette.Fire = {{134, 50, 46},{176, 70, 59},{200, 101, 91},{209, 134, 117},{214, 157, 133},{210, 208, 75},{208, 159, 67},{206, 130, 59},{204, 74, 51},{162, 47, 35}}
palette.Synthwave = {{52, 70, 122},{65, 94, 182},{52, 124, 150},{203, 113, 208},{201, 84, 128},{180, 54, 131},{122, 52, 73},{118, 76, 195},{142, 136, 151},{204, 159, 92}}
...
function applyCustCol(col)
  ...
  elseif cursorContext2 ~= 0 then 
    ...
    for selindex=0, count-1 do
      ...
      reaper.SetMediaItemInfo_Value(sel_item, "I_CUSTOMCOLOR", reaper.ColorToNative(table.unpack(col))|16777216)
...
tcpVolVals = {'KNOB',40,70,100,116,146,160,190}
...
undockPaletteNamesVals = {'REAPER v6', 'PRIDE','WARM','COOL','VICE','OK','SOFT','FOREST','FIRE','HARD','AUTUMN','SYNTHWAVE'}
...
_paletteBoxStroke = Element:new(_pageColor_und, {x=0,y=0,w=513,h=504,color={129,137,137}}) -- stroke
...
Element:new(_paletteBox, {x=50,y=112,w=410,h=30,text={str='Click a color to apply it to all selected tracks (+ Ctrl for all selected items)',style=3,align=5,col={129,137,137}}})
Button:new(_paletteBox, {x=140-112,y=146,w=30,img='color_apply_all',imgType=3,action=applyPalette,helpR=helpR_recolProject})
Element:new(_paletteBox, {x=179-112,y=146,w=208,h=30,text={str='Recolor project using this palette',style=2,align=4,col={129,137,137}},helpR=helpR_recolProject})
Button:new(_paletteBox, {x=280,y=146,w=30,img='color_apply_all',imgType=3,action=setItemsDefaultColor,helpR=helpR_recolProjec})
Element:new(_paletteBox, {x=319,y=146,w=208,h=30,text={str='Set items to default color',style=2,align=4,col={129,137,137}},helpR=helpR_recolProject})
_paletteMenuBox = Element:new(_paletteBoxStroke, {x=1,y=205,w=511,h=298,color={38,38,38}}) -- fill

-- add swatches
Swatch:new(_paletteMenuBox,{x=29,y=16,paletteIdx=1})
Swatch:new(_paletteMenuBox,{x=29,y=62,paletteIdx=3})
Swatch:new(_paletteMenuBox,{x=29,y=108,paletteIdx=5})
Swatch:new(_paletteMenuBox,{x=282,y=16,paletteIdx=2})
Swatch:new(_paletteMenuBox,{x=282,y=62,paletteIdx=4})
Swatch:new(_paletteMenuBox,{x=282,y=108,paletteIdx=6})
Swatch:new(_paletteMenuBox,{x=29,y=154,paletteIdx=7})
Swatch:new(_paletteMenuBox,{x=29,y=200,paletteIdx=8})
Swatch:new(_paletteMenuBox,{x=29,y=246,paletteIdx=9})
Swatch:new(_paletteMenuBox,{x=282,y=154,paletteIdx=10})
Swatch:new(_paletteMenuBox,{x=282,y=200,paletteIdx=11})
Swatch:new(_paletteMenuBox,{x=282,y=246,paletteIdx=12})

Button:new(_pageColor_und, {x=144,y=527,img='color_dim_all',imgType=3,action=reduceCustCol,param=false,helpR=helpL_colDimming})
Element:new(_pageColor_und, {x=183,y=527,w=208,h=30,text={str='Dim all assigned custom colors',style=2,align=4,col={129,137,137}},helpR=helpL_colDimming})
Button:new(_pageColor_und, {x=144,y=570,w=30,img='color_dim',imgType=3,action=reduceCustCol,param=true})
Element:new(_pageColor_und, {x=183,y=570,w=208,h=30,text={str='Dim custom colors on selected tracks',style=2,align=4,col={129,137,137}}})
...
function runloop()
  ...
  cursorContext2 = reaper.GetCursorContext2(true)
